...
// This is a placeholder component that would ideally use Mapbox or Google Maps
      ...
      <div class="bg-gray-200 dark:bg-gray-800 rounded-lg h-full w-full relative overflow-hidden">
        <div class="absolute inset-0 bg-blue-50 dark:bg-blue-950/20">
          ...
          ${projects.map(project => {
            ...
            return `
              <div class="absolute flex flex-col items-center" style="left: ${x}px; top: ${y}px; transform: translate(-50%, -50%);">
